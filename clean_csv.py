...
if __name__ == "__main__":
    ...
    round_df.to_csv("./db/round.csv", index=True)
    dealer_df.to_csv("./db/dealer.csv", index=True)
    player_df.to_csv("./db/player.csv", index=True)
    player_start_df.to_csv("./db/player_start.csv", index=True)