...
if __name__ == "__main__":
    ...
    round_df.to_excel("../csv/round.xlsx", index=True)
    dealer_df.to_excel("../csv/dealer.xlsx", index=True)
    player_df.to_excel("../csv/player.xlsx", index=True)
    player_start_df.to_excel("../csv/player_start.xlsx", index=True)